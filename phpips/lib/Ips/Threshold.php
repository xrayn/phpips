...
class Ips_Threshold {
	...
	private function _initThreshholds() {
		...
		Ips_Debugger::debug($this->_actionConfiguration);
		...
		Ips_Debugger::debug($this->_threshold);
	}
	...
	public function evaluateIntrusion ($vectorList, $vectorvalue) {
		...
		die();
		Ips_Debugger::debug(array("evaluateIntrusion"=>$vectorList));
		$highestAction = "";
